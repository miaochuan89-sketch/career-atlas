...
- 随阶段自动变化的 KPI 与投入权重
- 从 2026-08-22 重新启动的具体计划：未来两周每天一个 30–180 分钟、可检查验收的核心结果，不累计过期任务
- 本地持久化与 CSV 导出

## 安装（推荐）

打开 `outputs/installer/Career-Atlas-Setup-1.9.0.exe`，按提示完成安装。1.9.0 将每日任务改为当天优先，并为 2026-08-22 起的两周任务补全具体步骤、用时与验收标准。
